...
const ProtectedRoute = ({ element: Component, ...rest }) => {
    ...
    if (checkUser()) {
        ...
        return (
            <div>
              <p>You haven't supplied recognized user credentials.</p>
              <br />
              <p>To view or add comments, you must be logged in to your registered user account.</p>
              <br />
              <button onClick={notAuthHandler}>Login/register</button>
              <br />
